...
@else    
<link rel="stylesheet" href="{{ asset('storage/assets/css/govity-rtl.css') }}" />
<link rel="stylesheet" href="{{ asset('storage/assets/css/govity-rtl-custom.css') }}" />
<link rel="stylesheet" href="{{ asset('storage/assets/css/govity-responsive-rtl.css') }}" />
@endif
                            ...
                            <div class="main-menu__top-inner">
                                ...
                                <div class="main-menu__top-right">
                                    ...
                                    <ul class="list-unstyled main-menu__top-menu">
                                        ...
                                        <li><a href="{{ route('lang', (app()->getLocale() == 'en' ? 'ar' : 'en')) }}">{{ __('site.lang') }}</a></li>
                                    </ul>
                                </div>
            ...
            <div class="main-slider__carousel owl-carousel owl-theme thm-owl__carousel"
                ...
                <div class="item main-slider__slide-1">
                    ...
                    <div class="main-slider__shape-1">
                        <img src="{{ asset('storage') }}/assets/images/shapes/main-slider-shape-1{{ app()->getLocale() == 'en' ? '' : '-rtl' }}.png"
                            alt="">
                    </div>
                    <div class="main-slider__shape-2">
                        <img src="{{ asset('storage') }}/assets/images/shapes/main-slider-shape-2{{ app()->getLocale() == 'en' ? '' : '-rtl' }}.png"
                            alt="">
                    </div>
                    <div class="main-slider__shape-3">
                        <img src="{{ asset('storage') }}/assets/images/shapes/main-slider-shape-3{{ app()->getLocale() == 'en' ? '' : '-rtl' }}.png"
                            alt="">
                    </div>
